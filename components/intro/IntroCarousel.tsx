      ...
      <div className="px-5 pb-[calc(env(safe-area-inset-bottom)+20px)] pt-2">
        {isLast ? (
          <button
            type="button"
            onClick={onComplete}
            className="inline-flex h-14 w-full items-center justify-center gap-2 rounded-full bg-accent text-[16px] font-bold text-white transition-transform duration-fast ease-out active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-bg"
            style={{
          ...
          <div className="flex items-center justify-between">
            <button
              type="button"
              onClick={onComplete}
              className="rounded-md px-2 py-2 text-[15px] font-bold text-ink-tertiary transition-colors duration-fast ease-out hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
            >
              Skip
            </button>
            <button
